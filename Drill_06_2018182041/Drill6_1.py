...
def draw_curve_n_points(p):
    draw_big_point(p[0])#1
    draw_big_point(p[1])#2
    draw_big_point(p[2])#3
    draw_big_point(p[3])#4
    while(True):
        draw_curve_4_points(p[0],p[1],p[2],p[3])
        draw_curve_5_points(p[2],p[3],p[0],p[1])
    pass


prepare_turtle_canvas()
points = [(-300, 200), (400, 350), (300, -300), (-200, -200)]
draw_curve_n_points(points)
turtle.done()
